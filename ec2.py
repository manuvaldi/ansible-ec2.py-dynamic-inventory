...
Instead you can use config ec2.ini to include your credentials. Uncomment lines first in ec2.ini
...
class Ec2Inventory(object):
    ...
    def get_instances_by_region(self, region):
        ...
        try:
            if self.eucalyptus:
                ...
                conn = ec2.connect_to_region(region,aws_access_key_id=self.aws_access_key,aws_secret_access_key=self.aws_secret_key)
    ...
    def get_rds_instances_by_region(self, region):
        ...
        try:
            conn = rds.connect_to_region(region,aws_access_key_id=self.aws_access_key,aws_secret_access_key=self.aws_secret_key)
            if conn:
    ...
    def add_instance(self, instance, region):
        ...
        if instance.subnet_id:
            dest =  socket.getfqdn(getattr(instance, self.vpc_destination_variable))
        else:
